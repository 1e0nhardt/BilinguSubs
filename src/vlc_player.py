"""
copy from https://blog.csdn.net/yingshukun/article/details/89527561
"""

import os, platform

# 设置VLC库路径，需在import vlc之前
os.environ['PYTHON_VLC_MODULE_PATH'] = "lib/vlc-3.0.20"
...
class VlcPlayer:
    ...
    def set_time(self, ms):
        return self.set_position(ms / self.media.get_length())
    ...
    def set_position(self, float_val):
        # print(f"set_position {float(float_val):.3f}")
        return self.media.set_position(float(float_val))
    ...
    def add_update_callback(self, callback):
        self.add_callback(vlc.EventType.MediaPlayerTimeChanged, callback)
